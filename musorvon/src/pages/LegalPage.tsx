      ...
      <div className="flex-1 px-5 py-6 flex flex-col gap-6 max-w-lg mx-auto w-full">
        ...
        <Section title="4. УСЛОВИЯ ОКАЗАНИЯ УСЛУГИ">
          <ul className="flex flex-col gap-1.5 list-none">
            ...
            <li>4.3. Объём мусора — до 60 литров (один стандартный пакет).</li>
            <li>4.4. Услуга оказывается на территории жилого комплекса по адресу: ЖК «Настоящее», г. Москва, ул. Виницкая, 8.</li>
          </ul>
        </Section>
